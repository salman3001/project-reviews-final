...
import { productCategoryApi } from 'src/utils/BaseApiService';
...
const { onRequest, loading, rows } = onTableRequest(productCategoryApi, pagination, {
  populate: {
    subCategory: {
      fields: ['name', 'id'],
    },
    ...
    <div class="colomn q-gutter-y-lg" style="width: 100%">
      <div class="row justify-between q-gutter-y-sm">
        ...
        <div class="row q-gutter-sm">
          ...
          <ImportExcel type="product-category" />
          <ExportExcel type="product-category" />
      ...
      <q-table ref="tableRef" flat bordered title="Products Categories" :loading="loading" :rows="rows" :columns="colomns"
                ...
                <q-list dense>
                  ...
                  <q-item clickable v-close-popup @click="
                    modal.togel('deleteRecord', {
                      url: '/product-category/' + props.row.id,
                      tableRef,
