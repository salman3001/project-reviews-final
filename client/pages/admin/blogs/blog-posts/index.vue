  ...
  <section class="my-8">
    ...
    <div class="flex flex-wrap gap-4 justify-between mt-8">
      ...
      <div class="flex gap-4 flex-wrap">
        ...
        <NuxtLink href="/admin/blogs/create">
      ...
      <table class="table table-zebra mt-6 p  x-4">
        ...
        <tbody>
          <tr v-if="blogData" v-for="(blog, i) in blogData.blogs.data" :key="blog.id">
            <td>
              {{
                (blogData.blogs.meta.current_page - 1) * blogData.blogs.meta.per_page +
                (i + 1)
              }}
            </td>
            ...
            <td>
              <div v-if="blog.is_public == 1" class="badge badge-success badge-outline bg-base-200">
                Published
              </div>
            ...
            <td>
              <div class="dropdown dropdown-bottom">
                ...
                <ul class="p-1 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-32 border-t-4 border-black">
                  <li>
                    <NuxtLink :href="`/admin/blogs/${blog.id}`" class="text-sm p-1">view</NuxtLink>
                  </li>
                  <li>
                    <NuxtLink :href="`/admin/blogs/${blog.id}/edit/`" class="text-sm p-1">Edit</NuxtLink>
                  </li>
                  <li>
                    <button class="text-sm text-start p-1" @click="modal.togel('delete', {
